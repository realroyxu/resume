...
\Large{
  \begin{tabu}{ c l r }
   \multirow{5}{1in}{\includegraphics[width=0.88in]{avatar}} & \scshape{Roy Xu} & {Python~}\progressbar{0.4} \\
    & \email{section0.com@gmail.com} & {Flask~}\progressbar{0.3} \\
    & \phone{(+61) (0)431-332-881}  & {Database~}\progressbar{0.3}\\
    & \github[github.com/realroyxu]{https://github.com/realroyxu}  & {Linux~}\progressbar{0.5} 
  \end{tabu}
}
}
...
\begin{itemize}
  \item Running the club and organize events
...
\begin{itemize}
  \item Website continuos deployment with Gitlab and Jenkins
